    ...
    },*/
    {
      ...
      sub: [
        ...
        },
        {
          ...
          type: 'dropDown',
          sub: [
            {name: 'ITEM_TYPES', state: 'inventory/itemTypes'},
            {name: 'ITEM_CATEGORIES', state: 'inventory/itemCategories'},
            {name: 'ITEM_CLASSIFICATIONS', state: 'inventory/itemClassifications'},
          ]
        }         
      ]
    },
