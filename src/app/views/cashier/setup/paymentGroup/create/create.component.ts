...
@Component({
  selector: 'app-payment-group-create',
...
export class CreateComponent implements OnInit {
  ...
  async save(){ 
    if(this.model.valid){
    let addModel = new PaymentGroupModel(); 
    addModel.Name = this.model.controls['name'].value; 
    await lastValueFrom(this._commonCrudService.post("PaymentGroup/AddPaymentGroup", addModel, this.responseModel)).then(res => {
