...
export class DeleteComponent implements OnInit {
  ...
  async getData(id){ 
    await lastValueFrom(this._commonCrudService.get("ItemTypes/GetItemType/" + id, this.responseModel))
    .then(res => {
  ...
  async delete(){ 
    if(this.model.valid){
      await lastValueFrom(this._commonCrudService.delete("ItemTypes/" + this.Id))
      .then(res => {
