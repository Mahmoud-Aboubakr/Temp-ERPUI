...
export class UpdateComponent implements OnInit {
  ...
  async update(){ 
    if(this.model.valid){
      let updateModel = new ContactTypeModel(); 
      ...
      await lastValueFrom (  this._commonCrudService.update("ContactTypes/UpdateContact/" + this.Id, updateModel, this.responseModel)
      ) 
      .then(res => {
        this.responseModel = res;
